...
<?php if(!$step){ ?>
	...
	<h3>Welcome to a new CORAL Licensing installation!</h3>
	This installation will:
	<ul>
		<li>Check that you are running PHP 5</li>
		<li>Connect to MySQL and create the CORAL Licensing tables</li>
		<li>Test the database connection the CORAL Licensing application will use </li>
	...
	<ul>
		<li>Create a MySQL Schema for CORAL Licensing Module - recommended name is coral_licensing_prod.  Each CORAL module has separate user permissions and requires a separate schema.</li>
		...
		<li>If you are using the CORAL Authentication module, you will need to have it installed and your admin user set up before you can log into Licensing</li>
...
<?php
	...
	<h3>CORAL Licensing installation is now complete!</h3>
